...
\begin{abstract}
  ...
  attendant to this expansion. As a result, it is imperative to develop
  ...
  Cyclus includes socio-behavior models of individual actors, facilitating the
...
\bibliography{../zotero_151013,../websites_manual}
\end{small}
\end{document}
