...
\begin{tabular}{|c|c|c|}
\hline
\textbf{General}    & Dur. (months)      & 100  \\
\textbf{Simulation} & Nat. U \% $^{235}U$ & 0.7  \\
                    & LEU \% $^{235}U$    & 4.0  \\
                    & HEU \% $^{235}U$    & 90.0 \\
\hline
\textbf{Enrichment} & SWU Capacity (kg-SWU/month) & 180  \\
\textbf{Facility}   & Tails Assay (\%)   & 0.3  \\
\hline
