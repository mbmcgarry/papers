...
Once every state had been assigned a 0-10 score for each factor, a correlation analysis was applied to the derived factor scores to quantify the degree to which each individual factor is correlated to the decision whether or not to pursue weapons. \TODO{ADD DETAILS OF HOW THE CORRELATION ANALYSIS WAS DONE. Something about ordered results for pursue vs not-pursue. Final pursuit score defined as a weighted linear combination of the factors}.  
