...
- Cyclus: How it works, why it's different from other simulators, nonpro features

Model:
- Signatures available (Effluent, inspections, power, shipments)
- Social behavioral models available (random interactions, likeliness, preferences)

Analysis:
- Example: diversion from EF
- SWU/Power analysis
- UM result?

Conclusions/FutureWork:
- talk about satellite imaging
-talk about the toy model being made more realistic (changing power consumption to include non-SWU components, other models for HEU diversion)
